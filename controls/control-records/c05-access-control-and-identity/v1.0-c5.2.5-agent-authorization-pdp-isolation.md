...
a rolling adversary knowledge base; these relationships use the pinned `2026.08`
snapshot.
...
|---|---|---|---|
| 2026-09-03 | Initial verifiable draft prepared for human product-security review | Codex authoring agent; not a reviewer | Commit `5921431`; human review pending |
| 2026-09-04 | Scope-calibration draft separates PDP isolation from adjacent authorization, complete-mediation, and audit properties | Codex authoring agent based on human review feedback; not final approval | Working-tree revision; durable human review evidence pending |
